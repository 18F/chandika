...
<div class="container-fluid">
    ...
    <hr/>
    <h2>Add resource</h2>
    <p>For AWS resources, please use the <a
            href="http://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">ARN</a> as the URL.
    ...
    <form action="add_resource.php" method="POST">
        ...
        <label for="expiry_date">Expiry date</label> <input type="text" name="expiry_date" id="expiry_date"/><br/>
