...
if (isset($_REQUEST["action"]) && $_REQUEST["action"] == "Update") {
    ServiceAdministrator::update($service_id, $_REQUEST["name"], $_REQUEST["owner"], $_REQUEST["account_id"], $_REQUEST["repository"], $_REQUEST["url"], $_REQUEST["is_billable"], $_REQUEST["tag"]);
}
